function VelgAvdeling(props) {
  ...
  return (
    <>
      <button
        className="bg-sky-700 text-sky-100 w-20 h-20 rounded-full md:w-40 md:h-12 mt-2 mb-4 text-center hover:bg-lime-400 hover:text-green-900 focus:bg-lime-400 focus:text-green-900"
