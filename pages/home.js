...
function Home(props) {
  ...
  return (
    <>
      <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900 mt-11">
          ...
          >
            <ul className="flex flex-col p-4 mt-4 bg-gray-50 rounded-lg border border-gray-100 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700 ">
              <li>
                <a
                  href="#"
                  className="block py-2 pr-4 pl-3 text-white bg-sky-800 rounded md:bg-transparent md:text-sky-500 md:p-0 dark:text-white"
                  aria-current="page"
                >
                  Hjem
                </a>
